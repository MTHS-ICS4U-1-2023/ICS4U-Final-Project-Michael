...
# This program is for video 10 for TensorFlow
...
english = tf.data.TextLineDataset("/home/ec2-user/environment/ICS4U/Final-Project-TF/ICS4U-Final-Project-Michael/Video-19/tutorial19-customdata-text/english.csv")
swedish = tf.data.TextLineDataset("/home/ec2-user/environment/ICS4U/Final-Project-TF/ICS4U-Final-Project-Michael/Video-19/tutorial19-customdata-text/swedish.csv")
...
dataset1 = tf.data.TextLineDataset("/home/ec2-user/environment/ICS4U/Final-Project-TF/ICS4U-Final-Project-Michael/Video-19/tutorial19-customdata-text/test_example1.csv").skip(1)  # .map(preprocess1)
dataset2 = tf.data.TextLineDataset("/home/ec2-user/environment/ICS4U/Final-Project-TF/ICS4U-Final-Project-Michael/Video-19/tutorial19-customdata-text/test_example2.csv").skip(1)  # .map(preprocess1)
dataset3 = tf.data.TextLineDataset("/home/ec2-user/environment/ICS4U/Final-Project-TF/ICS4U-Final-Project-Michael/Video-19/tutorial19-customdata-text/test_example3.csv").skip(1)  # .map(preprocess1)
